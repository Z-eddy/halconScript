...
namespace HalconScript {
  ...
  {     
    static HDevEngineCpp::HDevProcedure procedure(GetProgram(sgResourcePath+"scriptTest.hdev"),"test");
    HDevEngineCpp::HDevProcedureCall call=procedure;
    ParamHandler<HalconCpp::HTuple>::SetParameter(call,"imagePath",imagePath);
